...
CREATE TABLE IF NOT EXISTS `crud_roles` (
  `id` int(11) NOT NULL auto_increment,
...
INSERT INTO `crud_roles` (`id`, `parent_id`, `name`) VALUES
(1, 0, 'User'),
(2, 0, 'Admin');
...
INSERT INTO `crud_users` (`id`, `role_id`, `username`, `password`, `email`, `banned`, `ban_reason`, `newpass`, `newpass_key`, `newpass_time`, `last_ip`, `last_login`, `created`, `modified`) VALUES
...
CREATE TABLE IF NOT EXISTS `crud_user_autologin` (
...
CREATE TABLE IF NOT EXISTS `crud_user_profile` (
  `id` int(11) NOT NULL auto_increment,
...
INSERT INTO `crud_user_profile` (`id`, `user_id`, `country`, `website`) VALUES
(1, 1, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `crud_user_temp` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Table structure for table `crud_sessions`
--

CREATE TABLE IF NOT EXISTS `crud_sessions` (
...
CREATE TABLE IF NOT EXISTS `crud_posts` (
  `CrudPostsId` int(11) NOT NULL AUTO_INCREMENT,
  `Title` text,
  `Content` text,
  `Approved` tinyint(1) NOT NULL DEFAULT '0',
  `TimeUpdated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `TimePosted` datetime DEFAULT NULL,
  PRIMARY KEY (`CrudPostsId`)
